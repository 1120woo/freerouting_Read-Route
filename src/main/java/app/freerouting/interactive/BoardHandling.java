...
public class BoardHandling extends BoardHandlingHeadless implements java.io.Serializable{
  ...
  public void create_board(
    ...
    this.coordinate_transform =
        new CoordinateTransform(
            1, p_board_communication.unit, unit_factor, p_board_communication.unit);
  ...
  public void change_user_unit(Unit p_unit) {
    ...
    this.coordinate_transform =
        new CoordinateTransform(
            old_transform.user_unit_factor,
            p_unit,
            old_transform.board_unit_factor,
            old_transform.board_unit);
  }
  ...
  public void select_items_in_region() {
    ...
    set_interactive_state(
        SelectItemsInRegionState.get_instance(this.interactive_state, this, activityReplayFile));
  }
  ...
  public void zoom_selection() {
    ...
    IntBox bounding_box =
        this.board.get_bounding_box(((SelectedItemState) interactive_state).get_item_list());
    bounding_box = bounding_box.offset(this.board.rules.get_max_trace_half_width());
    Point2D lower_left =
        this.graphics_context.coordinate_transform.board_to_screen(bounding_box.ll.to_float());
    Point2D upper_right =
        this.graphics_context.coordinate_transform.board_to_screen(bounding_box.ur.to_float());
  ...
  public void assign_selected_to_new_group() {
    ...
    InteractiveState new_state =
        ((SelectedItemState) interactive_state).assign_items_to_new_group();
    set_interactive_state(new_state);
  }
  ...
  public void assign_clearance_classs_to_selected_items(int p_cl_class_index) {
    ...
    InteractiveState new_state =
        ((SelectedItemState) interactive_state).assign_clearance_class(p_cl_class_index);
    set_interactive_state(new_state);
  }
  ...
  public void move_selected_items(Point2D p_from_location) {
    ...
    FloatPoint from_location =
        graphics_context.coordinate_transform.screen_to_board(p_from_location);
    InteractiveState new_state =
        MoveItemState.get_instance(
            from_location, item_list, interactive_state, this, activityReplayFile);
    set_interactive_state(new_state);
    repaint();
  }
  ...
  public void copy_selected_items(Point2D p_from_location) {
    ...
    InteractiveState new_state =
        CopyItemState.get_instance(
            from_location, item_list, interactive_state.return_state, this, activityReplayFile);
    set_interactive_state(new_state);
  }
  ...
  public void zoom_region() {
    interactive_state =
        ZoomRegionState.get_instance(this.interactive_state, this, this.activityReplayFile);
  }
  ...
  public void start_circle(Point2D p_point) {
    ...
    FloatPoint location = graphics_context.coordinate_transform.screen_to_board(p_point);
    set_interactive_state(
        CircleConstructionState.get_instance(
            location, this.interactive_state, this, activityReplayFile));
  }
  ...
  public void start_tile(Point2D p_point) {
    ...
    FloatPoint location = graphics_context.coordinate_transform.screen_to_board(p_point);
    set_interactive_state(
        TileConstructionState.get_instance(
            location, this.interactive_state, this, activityReplayFile));
  }
  ...
  public void start_polygonshape_item(Point2D p_point) {
    ...
    FloatPoint location = graphics_context.coordinate_transform.screen_to_board(p_point);
    set_interactive_state(
        PolygonShapeConstructionState.get_instance(
            location, this.interactive_state, this, activityReplayFile));
  }
  ...
  public void start_adding_hole(Point2D p_point) {
    ...
    FloatPoint location = graphics_context.coordinate_transform.screen_to_board(p_point);
    InteractiveState new_state =
        HoleConstructionState.get_instance(
            location, this.interactive_state, this, activityReplayFile);
    set_interactive_state(new_state);
  }
